...
using BuildingBlocks.Infrastructure.DependencyManagement;
using BuildingBlocks.Infrastructure.Mapper;
        ...
        foreach (var constructor in type.GetConstructors())
        {
            try
            {
                ...
                var parameters = constructor.GetParameters().Select(parameter =>
                {
                    ...
                    if (service == null)
                        throw new DomainException("Unknown dependency");
                    return service;
                });
