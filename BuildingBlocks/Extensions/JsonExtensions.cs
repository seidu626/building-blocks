...
public static partial class JsonExtensions
{
    ...
    {
        //return Newtonsoft.Json.JsonConvert.DeserializeObject<T>(element.GetRawText());
    ...
    private static object ToObject(this JsonElement element, Type returnType, JsonSerializerOptions options = null)
    {
        var bufferWriter = new ArrayBufferWriter<byte>();
        using (var writer = new Utf8JsonWriter(bufferWriter))
            element.WriteTo(writer);
