...
// Type: BuildingBlocks.Persistence.Hooks.HookableAttribute
...
namespace BuildingBlocks.Persistence.Hooks
{
  ...
  {
    public HookableAttribute(bool isHookable) => this.IsHookable = this.IsHookable;

    public bool IsHookable { get; private set; }
  }
}
